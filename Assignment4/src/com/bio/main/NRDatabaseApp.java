...
public class NRDatabaseApp {
	...
	public static final String Q_HMP_DB_META_HIT_NR_HMP_OUTPUT = "Q-HMP-DB-MetaHIT-nr-HMP-output";
	public static final String META_HIT_NR_HMP_FA = "MetaHIT-nr-HMP.fa";
	public static final String Q_METAHIT_DB_HMP_OUTPUT = "Q-MetaHIT-DB-HMP-output";
