...
public class MainTest {
	...
	private static final String EXON_ANNOT_1 = "chr	2	5	NM_032291_exon_0_0_chr_66999639_f	0	+";
	private static final String GENE_ANNOT_2 = "chr	0	12	NM_003689	0	-	19630718	19638618	0	7	1679,130,100,97,105,188,320,	0,3310,4294,4606,5450,5747,9119,";
	private static final String SAMPLE_1 = "AAccNNNNNtTggg";
	private static final String SAMPLE_2 = "aaccAAgttggg";
	private static final String GENE_ANNOT_1 = "chr	1	14	NM_003689	0	-	19630718	19638618	0	7	1679,130,100,97,105,188,320,	0,3310,4294,4606,5450,5747,9119,";
	private static final String GENE_ANNOT_POS = "chr	1	14	NM_003689	0	+	19630718	19638618	0	7	1679,130,100,97,105,188,320,	0,3310,4294,4606,5450,5747,9119,";

	private static final String EXON_ANNOT_FILE_PATH = Process.IO_PATH + "TestHG19-refseq-exon-annot-chr-2016";
	private static final String GENE_ANNOT_FILE_PATH = Process.IO_PATH + "TestHG19-refseq-gene-annot-filtered";
	private static final String chr_FILE_PATH = Process.IO_PATH + "simplecha.fa";
